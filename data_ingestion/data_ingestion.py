...
@dlt.source
def data_ingestion_source(api_secret_key: str = dlt.secrets.value):
    # print(f"api_secret_key={api_secret_key}")
    return data_ingestion_resource(api_secret_key)


@dlt.resource(write_disposition="append")
def data_ingestion_resource(
...
if __name__ == "__main__":
    ...
    pipeline = dlt.pipeline(
        ...
        dataset_name='data_ingestion_data',
    )

    data = list(data_ingestion_resource())
